...
{
    public static class SingleProcessUtils
    {
        ...
        /// 根据进程，显示其主窗体
        /// </summary> 
        private static void HandleRunningInstance(IntPtr mainWindowHandle)
        {

            ShowWindow(mainWindowHandle, SW_RESTORE);
            SwitchToThisWindow(mainWindowHandle, true);  //比SetForegroundWindow好用

            //Rect windowRec;
            //GetWindowRect(mainWindowHandle, out windowRec);
            //System.Drawing.Rectangle rect = System.Windows.Forms.SystemInformation.VirtualScreen;
            //SetWindowPos(mainWindowHandle, HWND_TOP, (rect.Width - (windowRec.Right - windowRec.Left)) / 2,
        ...
        public static void Singling(params string[] str)
        {
            ...
            if (instance != null)   //首先确定有无进程
            {
                ...
                {
                    HandleRunningInstance(pro.MainWindowHandle);
                }
                else
                {
